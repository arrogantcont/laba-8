...
public class DataBaseConnection {
    private static final Logger DB_LOGGER = Logger.getLogger(DataBaseConnection.class.getName());
    ...
    public DataBaseConnection() {
        ...
        try {
            if (conn != null) {
                ...
                DB_LOGGER.warning("Failed to make connection!");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void addUser(User user) throws SQLException {
        ...
        DB_LOGGER.info(String.format("%d user added", rows));
    }
